...
data class Cat(
    ...
    val lastFeedTime: Long = 0,
    val lastPlayTime: Long = 0,
    val lastCleanTime: Long = 0,
...
enum class CatAction(
    ...
    PET_HEAD("摸头", "🤚", 1, 5, 0, 2, 3_000, "轻轻摸摸猫的头"),
    SCRATCH_CHIN("挠下巴", "👆", 2, 8, 0, 2, 5_000, "挠挠猫的下巴"),
    RUB_BELLY("撸肚子", "🖐️", 3, 10, 0, 3, 8_000, "小心！猫可能会翻脸"),
    FEED_FOOD("喂猫粮", "🍖", 1, 3, -30, 0, 30_000, "给猫吃猫粮"),
    FEED_SNACK("喂零食", "🍤", 1, 8, -15, 0, 60_000, "给猫吃零食"),
    FEED_CAN("喂罐头", "🥫", 2, 6, -40, 0, 120_000, "给猫吃罐头"),
    PLAY_CAT_TEASE("逗猫棒", "🖶", 1, 12, 2, 10, 10_000, "用逗猫棒陪猫玩"),
    PLAY_BALL("毛线球", "🧶", 1, 10, 2, 8, 10_000, "和猫玩毛线球"),
    PLAY_LASER("激光笔", "🔴", 1, 15, 3, 12, 10_000, "用激光笔逗猫"),
    CLEAN_BATH("洗澡", "🛁", -1, -5, 0, 0, 300_000, "给猫洗澡，猫可能不开心"),
    CLEAN_BRUSH("梳毛", "💇", 1, 5, 0, 0, 120_000, "给猫梳毛"),
